...
#Set up objects ================================================================
#If objects have ending "July 1" -> Removed promiscuous labels
...
#Get the reference
embryo_atlas_20pct <- readRDS("/home/ssaab/links/scratch/data/embryo_atlas_25pct_singleR_reference_cells_geneSym_July1.rds") #Adds 7GB

#Load Seurat object -> 4% of data -> THIS IS PROJECT DATA
srt_rds <- readRDS("/home/ssaab/links/scratch/data/merged_all_with_metadata_4pct.rds")
...
#rownames(atlas) <- rowData(atlas)$gene_symbol #To set rownames to gene symbols in the case it isn't already set
...
saveRDS(annotations, file = "singleR_test2_results.rds")
cat("SingleR job done, without the promiscuous labels")
